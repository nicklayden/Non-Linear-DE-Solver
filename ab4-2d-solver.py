...
h= 0.001 # this is the step size for the ab4 method. too large = unstable shit solution. too small = too long to calculate
...
y0 = [-5,-1,-0.2,0,0.2,1,5]
x0 = [-5,-1,-0.2,0,0.2,1,5]
for i in x0:
    for j in y0:
